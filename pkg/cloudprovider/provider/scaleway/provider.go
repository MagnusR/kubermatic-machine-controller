...
import (
	...
	cloudInstance "github.com/magnusr/kubermatic-machine-controller/pkg/cloudprovider/instance"
	scalewaytypes "github.com/magnusr/kubermatic-machine-controller/pkg/cloudprovider/provider/scaleway/types"
...
func (p *provider) Create(ctx context.Context, log *zap.SugaredLogger, machine *clusterv1alpha1.Machine, _ *cloudprovidertypes.ProviderData, userdata string) (cloudInstance.Instance, error) {
